...
<html lang="en">
  <head>
    <title>Upper Balngoda Tea Factory</title>
    <meta charset="utf-8">
        ...
        <div class="container">
          <div class="row slider-text js-fullheight justify-content-center align-items-center" data-scrollax-parent="true">
            ...
            <div class="col-md-12 col-sm-12 text-center ftco-animate">
            	<span class="subheading">Upper Balangoda</span>
              <h1 class="mb-4">Tea Factory</h1>
            </div>
      ...
      <div class="slider-item js-fullheight" style="background-image: url(images/bg2.jpg);">
        ...
        <div class="container">
          <div class="row slider-text js-fullheight justify-content-center align-items-center" data-scrollax-parent="true">
            ...
            <div class="col-md-12 col-sm-12 text-center ftco-animate">
            	<span class="subheading">Upper Balangoda</span>
              <h1 class="mb-4">Tea Factory &amp; Tasty</h1>
            </div>
    			...
    			<div class="col-md-12">
    				<div class="featured">
    					<div class="row">
			              ...
			              <div class="menu-img img" style="background-image: url(images/teaType1.jpg);"></div>
			              <div class="text text-center">
		                  <h3>Black Tea</h3>
				              <p><span>Black Currant Tea</span>, <span>Chocolate Rose Tea</span>, <span>Ginger Snap</span>, <br> <span>Vanilla Peach</span></p>
			              </div>
			            </div>
    						</div>
    						<div class="col-md-3">
    							<div class="featured-menus ftco-animate">
			              <div class="menu-img img" style="background-image: url(images/teaType2.jpg);"></div>
			              <div class="text text-center">
		                  <h3>Green tea</h3>
				              <p><span>Mint Green Tea</span>, <span>Chamomile Green tea</span>, <span>Jasmine Green tea</span>, <span> Honey lemon green tea</span></p>
			              </div>
			            </div>
    						</div>
    						<div class="col-md-3">
    							<div class="featured-menus ftco-animate">
			              <div class="menu-img img" style="background-image:  url(images/teaType3.jpg);"></div>
			              <div class="text text-center">
		                  <h3>White Tea</h3>
				              <p><span>Silver Needle </span>, <span>White Peony</span>, <span>Tribute Eyebrow</span>,<br> <span>Long Life Eyebrow</span></p>
			              </div>
			            </div>
    						</div>
    						<div class="col-md-3">
    							<div class="featured-menus ftco-animate">
			              <div class="menu-img img" style="background-image:  url(images/teaType4.jpg);"></div>
			              <div class="text text-center">
		                  <h3>Oolong Tea</h3>
				              <p><span>Good</span> <span>Taste</span>, <span>Good</span> <span>Product</span></p>
			              </div>
			            </div>
    						</div>
    					</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-7 d-flex">
						<div class="img img-1 mr-md-2" style="background-image: url(images/plantation2.jpg);"></div>
						<div class="img img-2 ml-md-2" style="background-image: url(images/plantation1.jpg);"></div>
					</div>
	          ...
	          <p>Upper Balangoda is a pioneer in distributing wide range of tea in Sri Lanka and Internationally.
	          				 ...
	          				 Currently owned by Mr. Sarath Dissanayake. 
	          				 Upper Balangoda involve in publishing tea mainly for black tea (BOPA, BOPF, BOPSP, BOP1, FBOP, OP, OP1, PEK, BM etc..). Currently more than 170 employees work in the company.</p>
						<p class="time">
							<span>Monday - Sunday </span> 
							<span><strong>7.30AM to 3.00PM </strong></span>
							<span><strong>3.00PM to 7.30PM </strong></span>
							<span><strong>11.00PM to 7.00AM </strong></span>
							<span><a href="#">+94  77327451</a></span>
							<span><a href="#">+94  77833222</a></span>
						</p>
					</div>
				</div>
			</div>
    ...
    <section class="ftco-section">
        ...
        <div class="row no-gutters d-flex align-items-stretch">
        	<div class="col-md-12 col-lg-6 d-flex align-self-stretch">
              ...
              <div class="menu-img img" style="background-image: url(images/product1.jpg);"></div>
              <div class="text d-flex align-items-center">
		              ...
		              <p><span>Gift</span> <span>Collection</span> <span>Pack</span></p><p> <span>For You</span></p>
        	...
        	<div class="col-md-12 col-lg-6 d-flex align-self-stretch">
        		<div class="menus d-sm-flex ftco-animate align-items-stretch">
              <div class="menu-img img" style="background-image: url(images/product2.jpg);"></div>
              <div class="text d-flex align-items-center">
								<div>
	              	<div class="d-flex">
		                <div class="one-half">
		                ...
		                <div class="one-forth">
		                  <span class="price">Rs. 1470.00</span>
		                </div>
		              </div>
		              <p><span>Black Tea</span> <span>Mixed</span> <span>With</span> <span>Cinnamon</span></p>
		              <p><a href="#" class="btn btn-primary">Shop now</a></p>
	              </div>
              </div>
            </div>
        	...
        	<div class="col-md-12 col-lg-6 d-flex align-self-stretch">
        		<div class="menus d-sm-flex ftco-animate align-items-stretch">
              <div class="menu-img img order-md-last" style="background-image: url(images/product3.jpg);"></div>
              <div class="text d-flex align-items-center">
								<div>
	              	<div class="d-flex">
		                <div class="one-half">
		              ...
		              <p><span>Slim</span> <span>Your</span> <span>Figure</span> </p> <p><span>Using This</span></p>
		              <p><a href="#" class="btn btn-primary">Shop now</a></p>
	              </div>
              </div>
            </div>
        	...
        	<div class="col-md-12 col-lg-6 d-flex align-self-stretch">
        		<div class="menus d-sm-flex ftco-animate align-items-stretch">
              <div class="menu-img img order-md-last" style="background-image: url(images/product4.jpg);"></div>
              <div class="text d-flex align-items-center">
								<div>
	              	<div class="d-flex">
		                <div class="one-half">
		                  <h3>Jocko White Tea</h3>
		                </div>
		                <div class="one-forth">
		                  <span class="price">Rs. 2200.00</span>
		                </div>
		              </div>
		            <p><span>Original</span> <span>White</span> <span>Tea</span> </p> <p><span>For You</span></p>
        	...
        	<div class="col-md-12 col-lg-6 d-flex align-self-stretch">
        		<div class="menus d-sm-flex ftco-animate align-items-stretch">
              <div class="menu-img img" style="background-image: url(images/product5.jpg);"></div>
              <div class="text d-flex align-items-center">
								<div>
	              	<div class="d-flex">
		                <div class="one-half">
		              ...
		              <p><span>Special</span> <span>Oolong</span> <span>Tea</span> </p> <p><span>For you</span></p>
		              <p><a href="#" class="btn btn-primary">Shop now</a></p>
	              </div>
              </div>
            </div>
        	...
        	<div class="col-md-12 col-lg-6 d-flex align-self-stretch">
        		<div class="menus d-sm-flex ftco-animate align-items-stretch">
              <div class="menu-img img" style="background-image: url(images/product6.jpg);"></div>
              <div class="text d-flex align-items-center">
								<div>
	              	<div class="d-flex">
		                <div class="one-half">
		              ...
		              <p><span>New</span> <span>Black</span> <span>Tea</span> <span>With</span> </p> <p><span>BOPF</span></p>
		              <p><a href="#" class="btn btn-primary">Shop now</a></p>
	              </div>
              </div>
            </div>
            ...
            <div class="carousel-testimony owl-carousel ftco-owl">
              <div class="item">
                <div class="testimony-wrap text-center pb-5">
                  ...
                  <div class="text p-3">
                    <p class="mb-4">You are our happy customer. Thank you join with us.</p>
