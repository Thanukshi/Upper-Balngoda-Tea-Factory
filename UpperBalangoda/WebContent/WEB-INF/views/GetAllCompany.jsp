            ...
            <div class="row">   
             <div class="col-md-6 login-form-1">
                ...
                <div class="col-md-6 login-form-2">
                    ...
                    <form method="POST" action="UpdateSignUpServlet">
                    <h3>Sign Up</h3>
					...
					<input type="submit" value="Update SignUp" class="btnSubmit"/>
                           
                        </div>
                    </form>
                    
                     <div class="form-group">
                        <form method="POST" action="DeleteSignUpServlet">
                            <input type="hidden" name = "signUPID" value="<%=signUp.getCompanyID()%>" />
                            <input type="submit" value="Delete SignUp" class="btnSubmit"/>
                            </form>
                        </div>
                </div>
            </div>
