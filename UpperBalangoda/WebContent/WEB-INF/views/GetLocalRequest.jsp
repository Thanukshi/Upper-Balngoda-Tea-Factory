...
<%
		LocalRequest localRequest = (LocalRequest) request.getAttribute("localRequest");
	%>
	...
	<div class="page-wrapper bg-gra-03 p-t-45 p-b-50">
        <div class="wrapper wrapper--w790">
            <div class="card card-5">
                ...
                <div class="card-body">
                    ...
                    <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="localRequestID" disabled="disabled"
					value="<%=localRequest.getLocalRequestCompanyID()%>" />
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="LCompany" value="<%=localRequest.getLocalRequestCompanyName()%>" />
                                </div>
                            </div>
                        </div>
                         ...
                         <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="LAddres" value="<%=localRequest.getLocalRequestCompanyAddress()%>" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="email" name="Lemail" value="<%=localRequest.getLocalRequestCompanyEmail()%>" />
                                </div>
                            </div>
                       	</div>
                       	...
                       	<div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="Lfax" value="<%=localRequest.getLocalRequestCompanyFax()%>" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                <input class="input--style-5" type="tel"  name="LMphone" value="<%=localRequest.getLocalRequestCompanyMobile()%>" / >
                            </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                <input class="input--style-5" type="tel"  name="LO1phone" value="<%=localRequest.getLocalRequestCompanyOffice1()%>" />
                            </div>
                            </div>
                        </div>
                         ...
                         <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                <input class="input--style-5" type="tel"  name="LO2phone" value="<%=localRequest.getLocalRequestCompanyOffice2()%>" />
                            </div>
                            </div>
                        </div>
                        
                        <div class="form-row">
                            <div class="name">Tea Type</div>
                            <div class="value">
                                <div class="input-group">
                                <input class="input--style-5" type="tel"  name="LteaTypey" value="<%=localRequest.getLocalRequestCompanyTeaType()%>" />
                            </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                <input class="input--style-5" type="tel"  name="LQuantity" value="<%=localRequest.getLocalRequestCompanyQuntity()%>" />
                            </div>
                            </div>
                        </div>
              
              <input type="hidden" name="localRequestID" 
						value="<%=localRequest.getLocalRequestCompanyID() %>" /> 
					<input type="submit" value="Update Order" class="btn btn--radius-2 btn--red"/> 
            ...
            <form method="POST" action="DeleteLocalRequestServlet">
					<input type="hidden" name="localRequestID"
						value="<%=localRequest.getLocalRequestCompanyID()%>" /> <input type="submit"
						value="Delete Order" class="btn btn--radius-2 btn--red""/>
				</form>
         </div>
       </div>
     </div>
