      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate text-center mb-4">
            ...
            <p class="breadcrumbs"><span class="mr-2"><a href="index.jsp">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Sign In <i class="ion-ios-arrow-forward"></i></span></p>
          </div>
        </div>
      </div>
    </section>    
                ...
                <div class="col-md-6 login-form-2">
                    ...
                    <div class="form-group"  >
                            <select name="signUpCompanyType" class="form-control">
                                 <option disabled="disabled" selected="selected" >Choose Company Type</option>
                                 <option>Local Tea Broker Company</option>
                                 <option>International Tea Broker Company</option>
                          </select>
                        </div>
                        <div class="form-group">
                     ...
                     <div class="form-group">
                        <form method="POST" action="ListSignUpServlet">
                            <input type="submit" class="btnSubmit" value="Show Details" />
                            </form>
                        </div>
                </div>
            </div>
