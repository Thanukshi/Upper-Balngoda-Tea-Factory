 ...
 */
public class EditCompanyGetSignUpServlet extends HttpServlet {
	 ...
	 */
	public EditCompanyGetSignUpServlet() {
		super();
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/WEB-INF/views/GetOneCompany.jsp");
