 ...
 */
public class CompanyGetSignUpServlet extends HttpServlet {
	 ...
	 */
	public CompanyGetSignUpServlet() {
		super();
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/WEB-INF/views/MyProfile.jsp");
